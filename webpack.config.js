...
const APP_ID = process.env.ZETKIN_APP_ID || 'a5';
const USE_TLS = process.env.ZETKIN_USE_TLS || 0;
const DOMAIN = process.env.ZETKIN_DOMAIN;

const NODE_ENV = process.env.NODE_ENV || 'development';
const WEBPACK_HOST = process.env.WEBPACK_HOST || 'call.dev.zetkin.org';
...
const config = {
    ...
    plugins: [
        new webpack.DefinePlugin({
            ...
            'process.env.VOIP_EMBED_URL': JSON.stringify(process.env.VOIP_EMBED_URL),
        }),
